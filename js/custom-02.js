...
while(currentGen<=4){
    ...
    currentGen++
    totalMW+=64
   console.log(`Generatorius #${currentGen} įjungtas, pridėjo 64 MW, viso generuojama ${totalGen} MW!`) 
}
for(let i =5; i<19; i++ ){
    currentGen++
    totalMW+=124
    console.log(`Generatorius #${currentGen} įjungtas, pridėjo  124 MW, viso generuojama ${totalGen} MW!`) 
}
